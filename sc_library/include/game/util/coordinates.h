...
namespace Coordinates {
	...
	{
		const Coordinate LEFT = Coordinate(+2, 0);
		const Coordinate RIGHT = Coordinate(-2, 0);
		const Coordinate UP_LEFT = Coordinate(-1, -1);
		const Coordinate UP_RIGHT = Coordinate(+1, -1);
		const Coordinate DOWN_LEFT = Coordinate(-1, +1);
		const Coordinate DOWN_RIGHT = Coordinate(+1, +1);
		const Coordinate directions[6] = { LEFT, RIGHT, UP_LEFT, UP_RIGHT, DOWN_LEFT, DOWN_RIGHT };
	};
}